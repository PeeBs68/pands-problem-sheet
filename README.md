...
For the histogram we create variables and assign values to them for the count of numbers to be used along with the mean and standard deviation. We then use these in np.random.normal() to create a list of random, normalised numbers for our plot.   
...
Then using the features of matplotlob we create lables, legend, title etc for the plot. Finally, using plt.show() we display the plot.
